...
\end{lstlisting}
Flash firmware.bin obtained upon execution of the above code to the ESP32.  You should see the number 9 on the display.  The following function generates this number.
\begin{lstlisting}
