...
int main(void)
{
  ...
  while(1)
  {
   ...
   if((PyHal_GPIO_Get(11)==1 && PyHal_GPIO_Get(12)==1) && PyHal_GPIO_Get(26)==0)
  {
    Forward();
  ...
  {
    if((PyHal_GPIO_Get(11)==0 && PyHal_GPIO_Get(12)==0) && PyHal_GPIO_Get(26)==1 )
    {
      Back();
      ...
      {
      if(PyHal_GPIO_Get(11)==0 && PyHal_GPIO_Get(12)==1)
       {
         Right();
        ...
        {
          if(PyHal_GPIO_Get(11)==1 && PyHal_GPIO_Get(12)==0)
          {
           Left();
