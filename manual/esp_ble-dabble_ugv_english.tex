...
\title{
%	\logo{
Display control over Bluetooth using  ESP32
...
\begin{abstract}
This document shows how to drive a seven segment display over bluetooth using the  ESP32 and the Dabble app.
...
\begin{lstlisting}
  https://github.com/gadepall/ugv/tree/main/codes/ble-dabble
\end{lstlisting}
%
...
\item Fig.\ref{fig:pin_sheet} shows all the pins of the ESP32. Connect the pins of the
display in Fig.  \ref{fig:sevenseg} to the ESP32 using Table \ref{table:sevenseg}.
The COM pin should be connected to 3.3V through a resistor.
\begin{table}[!ht]
\centering
\resizebox{\columnwidth}{!}{
\input{tables/esp_sevenseg.tex}
}
\caption{Display-ESP32 connection.}
...
\begin{figure*}[!ht]
\centering
\includegraphics[width = \textwidth]{figs/esp-devkit.jpg}
\caption{Pin Diagram.  Note that the pin diagram may vary depending upon the ESP32 variant.}
\label{fig:pin_sheet}
\end{figure*}



\item Now execute the following code using platformio
\label{code:sevenseg}
\begin{lstlisting}
  codes/ble-dabble/src/main.cpp
\end{lstlisting}
Flash firmware.bin obtained upon execution of the above code to the ESP32.  
%\item 
% You should see the number 9 on the display.  The following function generates this number.
% \begin{lstlisting}
...
% \end{table}
\item Now display the numbers 0-4 on the seven segment display using the dabble app as shown in Fig. \ref{fig:dabble}
\begin{figure*}[!ht]
  \centering
  \includegraphics[width = \textwidth]{figs/dabble.jpg}
  \caption{Dabble app to control the display over bluetooth}
  \label{fig:dabble}
  \end{figure*}
...
% % Fig.  \ref{fig:pins}  show how to use the pins of the ESP32 to drive the seven segment display.
...
% % \label{fig:pins}
% % \end{figure*}
% \item Use a function taking binary input in the code in  \ref{code:sevenseg} to generate 
% numbers on the display.
% \\
% \solution  Execute the following file.
% \begin{lstlisting}
%   codes/input/src/main.cpp
% \end{lstlisting}
% \item Program the ESP32 to function as a decade counter.
% % \\
